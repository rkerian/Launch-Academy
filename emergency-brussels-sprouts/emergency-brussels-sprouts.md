...
2) When you're ready to start writing code, run `rake`. Rake will run the `Rspec` tests that have been provided as part of this challenge. You'll also see rake again later, but you don't need to know more about it for now.
